...
let sha224Password = 'b6e9bd098d0238477f1c83ab093bbb098fe3da89ccf03be77bfc640b';
let proxyIP = "";
            ...
            if (!upgradeHeader || upgradeHeader !== "websocket") {
                ...
                switch (url.pathname) {
                    case "/link":
                        ...
                        return new Response(`trojan://fuckGFW777@${host}:443/?type=ws&host=${host}&security=tls`, {
                            status: 200,
                            headers: {
